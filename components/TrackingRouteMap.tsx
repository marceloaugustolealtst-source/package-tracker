...
export default function TrackingRouteMap({origin,destination,status,events:initialEvents}:Props){
  ...
  return <section className="tracker-card">
    ...
    <style jsx>{`
      ...
      .pill{padding:5px 8px;border-radius:14px;font-size:8px;font-weight:900;line-height:1}.checkpoint-active{background:#fee2e2;color:#b00000;border:1px solid #dc2626;animation:checkpointBlink 1s infinite}.moving{background:#dcfce7;color:#16a34a;border:1px solid #16a34a}.moving::before{content:'●';margin-right:4px;display:inline-block}.checkpoint{background:#f5f5f3;color:#7a1f16}
