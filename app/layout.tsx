...
export const metadata={title:'UPC Package Tracker',description:'Track your UPC shipment quickly and securely with real-time delivery updates.',metadataBase:new URL(process.env.NEXT_PUBLIC_SITE_URL||'https://upctracker.site'),icons:{icon:'/icon.svg',shortcut:'/icon.svg',apple:'/icon.svg'},openGraph:{title:'UPC Package Tracker',description:'Track your delivery with real-time shipment updates.',url:'https://upctracker.site/',type:'website',siteName:'UPC Package Tracker',images:[{url:'https://upctracker.site/api/og?v=3',width:1200,height:630,type:'image/png',alt:'UPC Package Tracker'}]},twitter:{card:'summary_large_image',title:'UPC Package Tracker',description:'Track your delivery with real-time shipment updates.',images:['https://upctracker.site/api/og?v=3']}}
